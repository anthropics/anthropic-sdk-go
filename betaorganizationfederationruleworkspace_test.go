...
func TestBetaOrganizationFederationRuleWorkspaceListWithOptionalParams(t *testing.T) {
...
func TestBetaOrganizationFederationRuleWorkspaceAddWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
...
func TestBetaOrganizationFederationRuleWorkspaceRemoveWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
